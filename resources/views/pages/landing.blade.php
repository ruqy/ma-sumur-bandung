...
<head>
    ...
    <link href="{{asset('css/slanding.css')}}" rel="stylesheet" />
</head>
...
<body id="page-top">
    ...
    <section class="page-section" id="testimoni">
        <div class="container text-center">
            ...
            <hr class="divider my-4" />
            <img class="img-profil" src="{{asset('img/avatar.jpg')}}" alt="User profile picture">
            <h2>Sirojuddin</h2>
                ...
                <div class="col-lg-8 text-center">
                    ...
                    <form action="" method="post" class="text-left">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nomer" placeholder="Nomor Whatsapp diutamakan">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Asal Sekolah</label>
                            <input type="text" class="form-control" id="sekolah" placeholder="Nama sekolah sebelumnya">
                        </div>
